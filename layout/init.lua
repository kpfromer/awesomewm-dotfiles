...
-- local bottom_panel = require('layout.bottom-panel-surreal')
-- TODO: theme hot swap
local bottom_panel = require('layout.bottom-panel-linear')
  ...
  for s in screen do
    ...
    if s.selected_tag then
      ...
      if s.control_center then
        ...
        elseif not fullscreen and not focused.control_center.visible and
      ...
      if s.info_center then
        ...
        elseif not fullscreen and not focused.info_center.visible and focused.info_center_show_again then
