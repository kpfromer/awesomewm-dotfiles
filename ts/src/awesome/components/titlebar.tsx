...
export const FloatingButton: JSX.FunctionComponent<TitlebarProps> = ({ client }) => {
  return awful.titlebar.widget.floatingbutton(client) as any;
};

export const MinimizeButton: JSX.FunctionComponent<TitlebarProps> = ({ client }) => {
  return awful.titlebar.widget.minimizebutton(client) as any;
};

export const MaximizedButton: JSX.FunctionComponent<TitlebarProps> = ({ client }) => {
